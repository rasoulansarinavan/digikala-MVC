...
var loadProvinces = function () {
    var t = $(this);
    t.empty(), t.append($("<option></option>").attr("value", "empty")), $.each(data, function (a, i) {
        var o = $("<option></option>").attr("value", a).text(a);
        t.append(o)
    })
}, loadCities = function () {
    var t = $(this).closest("div.ir-select").find(".ir-city"), a = $(this).val(), i = data[a];
    t.empty(), $.each(i, function (a, i) {
